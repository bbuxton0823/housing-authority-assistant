...
general_info_agent = Agent[HousingAuthorityContext](
    ...
    IMPORTANT: When discussing tenant-landlord issues, emphasize that Project Sentinel offers bilingual services and has experience with local housing laws. This is often more effective than trying to resolve disputes on your own. You can find more information at the Project Sentinel page.
