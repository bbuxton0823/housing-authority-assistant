...
# Import voice service only (skip navigation for now)
...
async def chat_endpoint(req: ChatRequest):
    """Main chat endpoint with real Housing Authority agents and voice support."""
...
if __name__ == "__main__":
    import uvicorn
    print("🏠 Housing Authority Assistant - Voice Enabled")
    print("=" * 50)
    print(f"Voice Service: {'✅ Enabled' if voice_service.enabled else '❌ Disabled'}")
