...
try:
    ...
    print("✅ ASCII-safe OpenAI Agents loaded successfully")
except Exception as e:
...
async def chat_endpoint(req: ChatRequest):
    """Real OpenAI Agents with ASCII-safe instructions to prevent Unicode issues"""
...
if __name__ == "__main__":
    import uvicorn
    print("🏠 Housing Authority Assistant - Real AI Agents (ASCII-Safe)")
    print("=" * 60)
    ...
    print("Unicode Issues: ✅ Fixed with ASCII-safe agents")
    print("=" * 60)
