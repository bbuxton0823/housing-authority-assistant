...
# Disable OpenAI Agents tracing to avoid Unicode issues
...
# Import main agents and configure OpenAI SDK
try:
    # Configure OpenAI Agents SDK before importing
    from agents import set_tracing_disabled, enable_verbose_stdout_logging
    
    # Disable tracing to prevent Unicode issues
    ...
    print("✅ OpenAI Agents loaded successfully (tracing disabled)")
except Exception as e:
...
async def chat_endpoint(req: ChatRequest):
    """Real OpenAI Agents with tracing disabled to prevent Unicode issues"""
    ...
    try:
        # Run the real OpenAI Agents with tracing disabled
...
if __name__ == "__main__":
    import uvicorn
    print("🏠 Housing Authority Assistant - Real AI (No Tracing)")
    print("=" * 60)
    ...
    print("Tracing: ❌ Disabled (Unicode fix)")
